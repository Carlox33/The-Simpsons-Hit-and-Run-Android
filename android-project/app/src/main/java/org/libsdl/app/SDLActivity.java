...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mBrokenLibraries) {
            ...
            Log.i(TAG, "SDL expected (Java constants): " + expected_version);
            Log.i(TAG, "SDL runtime (nativeGetVersion): " + version);
            Log.i(TAG, "SDL nativeLibraryDir: " + getApplicationInfo().nativeLibraryDir);
