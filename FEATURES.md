...
* ✔ **Los iconos táctiles han sido diseñados por mí al completo.**

---

* ✔ **Tutoriales del inicio desactivados.**
...
* ✔ **Soporte para mandos externos**
  ...
  Se ha incorporado **vibración para mandos**, solo en **64 bits**, ya que muchos dispositivos **32 bits** tienen problemas para reconocer, por sus propios drivers, si un mando puede vibrar o no.
...
* ✔ **The implemented touch controls are intelligent** and adapt to the different contexts of the player while on foot.

---

* ✔ **The touch icons have been entirely designed by me.**

---

* ✔ **Initial tutorials disabled.**
...
* ✔ **Support for external controllers**
  ...
  The game is compatible with **external controllers**, using a control scheme adapted to **modern controller standards**.
...
* ✔ **Les icônes tactiles ont été entièrement conçues par moi.**

---

* ✔ **Tutoriels du début désactivés.**
...
* ✔ **Limiteur de FPS ajouté à 60 images par seconde**
  ...
  * erreurs d’animation ou de logique du jeu
...
* ✔ **Die implementierte Touch-Steuerung ist intelligent** und passt sich den verschiedenen Situationen des Spielers zu Fuß an.

---

* ✔ **Die Touch-Symbole wurden vollständig von mir entworfen.**

---

* ✔ **Anfangs-Tutorials deaktiviert.**
